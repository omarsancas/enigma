...
vc_map( array(
      ...
      "params" => array(
         ...
         array(
            ...
            "param_name" => "icon",
            "value" => '',
            "description" => __('Enter icons name to display in iconbox. Icon list - ', 'richer-framework').'<a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">'.__('refer here', 'richer-framework').'</a>'
         ),
         array(
            "type" => "dropdown",            
            "class" => "",
...
vc_add_param("vc_row", array(
   ...
   "heading" => __("Disable container(width for content) inside section?",'richer-framework'),
...
vc_add_param("vc_row", array(
   ...
   "heading" => __("Poster",'richer-framework'),
   "param_name" => "poster",
   "value" => '',
   "description" => __('Defines image to show as placeholder before the media plays.','richer-framework'),
));
vc_add_param("vc_row", array(
   "type" => "textfield",
   "class" => "",
   "group" => 'Video Background',
   "heading" => __("mp4 source (url)",'richer-framework'),
   "param_name" => "mp4",
   "value" => '',
   "description" => __('The source of your video file. You can use this option to define specific filetypes.','richer-framework'),
));
vc_add_param("vc_row", array(
   "type" => "textfield",
   "class" => "",
   "group" => 'Video Background',
   "heading" => __("m4v source (url)",'richer-framework'),
   "param_name" => "m4v",
   "value" => '',
   "description" => __('The source of your video file. You can use this option to define specific filetypes.','richer-framework'),
));
vc_add_param("vc_row", array(
   ...
   "class" => "",
   "group" => 'Video Background',
   "heading" => __("webm source (url)",'richer-framework'),
   "param_name" => "webm",
   "value" => '',
   "description" => __('The source of your video file. You can use this option to define specific filetypes.','richer-framework'),
));
vc_add_param("vc_row", array(
   ...
   "class" => "",
   "group" => 'Video Background',
   "heading" => __("ogv source (url)",'richer-framework'),
   "param_name" => "ogv",
   "value" => '',
   "description" => __('The source of your video file. You can use this option to define specific filetypes.','richer-framework'),
));
vc_add_param("vc_row", array(
   ...
   "class" => "",
   "group" => 'Video Background',
   "heading" => __("Overlay",'richer-framework'),
   "param_name" => "overlay",
   "value" => '',
   "description" => __('You can specify overlay pattern on your video.','richer-framework'),
));
vc_add_param("vc_row", array(
   "type" => "dropdown",
   "class" => "",
   "group" => 'Design options',
   "heading" => __("Parallax option",'richer-framework'),
   "param_name" => "parallax",
   "value" => $no_yes,
   "description" => __('Set to yes if you wang to use parallax. Also backgroud control options set to "Theme defaults"','richer-framework'),
));

vc_add_param("vc_row", array(
   "type" => "textfield",
   "class" => "",
   "heading" => __("Row ID",'richer-framework'),
   "param_name" => "row_section_id",
   "value" => '',
   "description" => __('Use this field to anchor your menu item with your section. Commonly used for One-Page designs.','richer-framework'),
));
