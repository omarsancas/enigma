...
<?php if($options_data['custom_font_woff'] || $options_data['custom_font_ttf'] || $options_data['custom_font_svg'] || $options_data['custom_font_eot']):
...
<?php endif; ?>
	body{ 
		...
		if( get_post_meta( get_the_ID(), 'richer_bgurl', true ) != '' ) {
			...
			if(get_post_meta( get_the_ID(), 'richer_bgcolor', true )) { echo 'background-color: '.get_post_meta( get_the_ID(), 'richer_bgcolor', true ).';';}
			if(get_post_meta( get_the_ID(), 'richer_bgurl', true )) { echo 'background-image: url('.$src.');background-position:'.get_post_meta( get_the_ID(), 'richer_bg_position_x', true ).' '.get_post_meta( get_the_ID(), 'richer_bg_position_y', true ).';';}
			if(get_post_meta( get_the_ID(), 'richer_bgstyle', true ) != 'stretch') { 
				echo "background-repeat: ".get_post_meta( get_the_ID(), 'richer_bgstyle', true ).";"; 
			} else { 
				echo '-webkit-background-size: 100% auto; -moz-background-size: 100% auto; -o-background-size: cover; background-size: 100% auto; background-attachment: fixed;';  
			}
	...
	#header .logo a img { max-width: <?php echo $options_data['style_logomaxwidth']; ?>px; }
	...
	#header .logo,
	#header .logo .logo_text {color:<?php echo $options_data['color_headertext']; ?>; }
	#header { border-bottom: <?php echo $options_data['border_header']['width']; ?>px <?php echo $options_data['border_header']['style']; ?> rgba(<?php echo HexToRGB($options_data['border_header']['color']); ?>, <?php echo $options_data['header_bg_opacity']*0.01; ?>);}
	...
	#navigation ul.menu > li.menu-item {line-height: <?php echo $options_data['style_headerheight']; ?>px;}
	#header.header1 .my-table,
	#header.header2 .my-table { height: <?php echo $options_data['style_headerheight']; ?>px;}
	#header.header-scrolled {background-color: rgba(<?php echo HexToRGB($options_data['color_headerbg']);?>,0.9); }
	/* Top sliding area  ------------------------------------------------------------------------ */
	...
	#topnav li.current_page_ancestor a:hover { color: <?php echo $options_data['topnav_color_navlinkactive']; ?>; }
	...
	#footer .widget .separator {
		...
		margin-bottom:<?php if($options_data['border_footerheadline']['width'] == '0' || $options_data['border_footerheadline']['style'] == 'none') {echo '0px';} ?>;
	}
	#footer .widget .separator .separator_line {height:<?php if($options_data['border_footerheadline']['width'] != '0' && $options_data['border_footerheadline']['style'] != 'none') {echo "".($options_data['border_footerheadline']['width']+2)."px";} else {echo '0px';} ?>;}
	/* Copyright ------------------------------------------------------------------------ */  
	...
	.tabset .tab a.selected i, .tabset .tab a:hover i, .tabset .tab a.selected h6, .tabset .tab a:hover h6 { color:<?php echo $options_data['color_accent']; ?>;}
	...
	#pagination a:hover, #pagination span.current {background-color: <?php echo $options_data['color_accent']; ?>;}
	...
	.button:hover, .button.gradient.default:hover, .button.default:hover, input.button:hover, .loadmore.default:hover {background-color: <?php echo $options_data['button_color_hover']; ?> !important; color: #fff !important; ?>;}
...
<?php }
add_action( 'wp_head', 'richer_styles_custom', 100 );
?>